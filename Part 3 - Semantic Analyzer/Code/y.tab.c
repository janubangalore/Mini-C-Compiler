...
static const yytype_uint16 yyrline[] =
{
     ...
     221,   224,   240,   241,   242,   243,   244,   245,   248,   249,
     250,   251,   252,   253,   254,   255,   256,   259,   260,   261,
     262,   265,   296,   297,   300,   306,   314,   315,   318,   319
};
#endif
...
#line 261 "SemanticParser.y"
  ...
  case 110:
/* Line 1792 of yacc.c  */
#line 262 "SemanticParser.y"
    {(yyvsp[(1) - (1)].entry)->is_constant=1; (yyval.entry) = (yyvsp[(1) - (1)].entry);}
    break;

  case 111:
/* Line 1792 of yacc.c  */
#line 265 "SemanticParser.y"
    {
																															if(is_declaration)
																															{
...
#line 296 "SemanticParser.y"
  ...
  case 113:
/* Line 1792 of yacc.c  */
#line 297 "SemanticParser.y"
    {(yyval.entry) = (yyvsp[(1) - (1)].entry);}
    break;

  case 114:
/* Line 1792 of yacc.c  */
#line 300 "SemanticParser.y"
    {
																													(yyval.data_type) = (yyvsp[(1) - (4)].entry)->data_type;
...
#line 306 "SemanticParser.y"
  ...
  case 118:
/* Line 1792 of yacc.c  */
#line 318 "SemanticParser.y"
    {	param_list[p_idx++] = (yyvsp[(1) - (1)].data_type);	}
    break;

  case 119:
/* Line 1792 of yacc.c  */
#line 319 "SemanticParser.y"
